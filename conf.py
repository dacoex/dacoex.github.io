...
BLOG_AUTHOR = "DaCoEx"  # (translatable)
BLOG_TITLE = "DaCoEx to the World"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://dacoex.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://0.0.0.0:8000/"
BLOG_EMAIL = "dacoex@public-files.de"
BLOG_DESCRIPTION = "A coder's place in the wild."  # (translatable)
...
#TODO: activate links as fit
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
            ('/index.html', 'Home', 'icon-home'),
            ('/stories/about/', 'About me', 'icon-user'),
            ('/projects/', 'Projects', 'icon-tasks'),
            # activate later, once content is available ==> may need adjustment of the site theme: reduce top spacing of navigation bar
            #('/stories/travel/', 'Travel', 'icon-suitcase'),
            ('/stories/pages/', 'Pages', 'icon-book'),
            ('https://twitter.com/dacoex/with_replies', 'My Twitter', 'icon-twitter'),
            ('https://github.com/dacoex', 'My Github', 'icon-github'),
            ('https://launchpad.net/~dacoex', 'On Launchpad', 'icon-linux'),
#            ('/archive.html', 'Archives', 'icon-archive'),
            ('/categories/index.html', 'Categories & Tags', 'icon-tags'),
            # alternative, see `6.3 Tags and Categories <http://louistiao.me/posts/how-i-customized-my-nikola-powered-site.html#id21>`_
            #('/categories/index.html', 'Categories', 'icon-folder-open'),
...
#THEME = "bootstrap3"
# does not support
# `Post Types <https://getnikola.com/handbook.html#id20>`_
THEME = "zen-ipython"
...
POSTS = (
    ...
    #("owncloud_posts/*.rst", "posts", "post.tmpl"),
    #("owncloud_posts/*.txt", "posts", "post.tmpl"),
...
PAGES = (
    ...
    #("owncloud_stories/*.rst", "stories", "story.tmpl"),
    #("owncloud_stories/*.txt", "stories", "story.tmpl"),
)
...
#REDIRECTIONS = [("stories/projects/", "/projects")]
